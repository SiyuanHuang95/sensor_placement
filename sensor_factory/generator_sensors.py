...
class CSensorFactory:
    ...
    @staticmethod
    def get_position():
        position = random.randint(-CSensorFactory.area_length+1, CSensorFactory.area_length-1)
    ...
    def sensor_dict(sensor_name):
        if sensor_name == 'CMate':
            ...
            parameters = {'x': CSensorFactory.get_position(), 'y': CSensorFactory.get_position(), 'lidar_range': random.randint(3, 8),
